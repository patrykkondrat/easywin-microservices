...
//        properties.put(JsonDeserializer.TYPE_MAPPINGS, "ticket:com.easywin.notificationservice.event.TicketPlaceEvent,promo:com.easywin.notificationservice.event.TicketPlaceEvent");
